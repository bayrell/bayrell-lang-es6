...
BayrellLang.Parser.Exceptions.ParserError = class extends Runtime.Exceptions.RuntimeException{
	constructor(s, code, context, prev){
		...
		if (code == -1){
			code = BayrellLang.Parser.ParserConstant.ERROR_PARSER;
		}
		super(s, code, context, prev);
	}
	/* ======================= Class Init Functions ======================= */
	getClassName(){return "BayrellLang.Parser.Exceptions.ParserError";}
	static getCurrentNamespace(){return "BayrellLang.Parser.Exceptions";}
	static getCurrentClassName(){return "BayrellLang.Parser.Exceptions.ParserError";}
