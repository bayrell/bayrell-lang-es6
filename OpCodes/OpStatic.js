...
BayrellLang.OpCodes.OpStatic = class extends BayrellLang.OpCodes.BaseOpCode{
	...
	assignObject(obj){
		if (obj instanceof BayrellLang.OpCodes.OpStatic){
	...
	assignValue(variable_name, value){
		if (variable_name == "op") this.op = Runtime.rtl.correct(value, "string", "op_static", "");
