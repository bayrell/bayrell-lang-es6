...
BayrellLang.OpCodes.OpDynamic = class extends BayrellLang.OpCodes.BaseOpCode{
	/**
	 * Constructor
	 */
	...
	static getCurrentClassName(){return "BayrellLang.OpCodes.OpDynamic";}
	...
	assignObject(obj){
		if (obj instanceof BayrellLang.OpCodes.OpDynamic){
	...
	assignValue(variable_name, value, sender){if(sender==undefined)sender=null;
		if (variable_name == "op")this.op = Runtime.rtl.convert(value,"string","op_dynamic","");
